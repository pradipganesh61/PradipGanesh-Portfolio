...
export const projectsData = [
    {
        ...
        description: "I developed a .NET-based Support Pass-Through Child-Care application integrated with the Commonwealth of Pennsylvania's eCIS system, collaborating with 17 other teams to streamline processes for residents and vendors. Using .NET and Oracle, I built a robust back-end to handle complex eligibility calculations and business rule validations. I also created a responsive, user-friendly front-end with React, ensuring compliance with state and federal regulations. This resulted in a 20% reduction in latency, improved data processing efficiency, and enhanced user experience, all while maintaining strict security standards.",
        tools: ['.NET Core', 'Oracle', 'Azure', 'MVC'],
        code: '',
        demo: '',
        image: ayla,
    ...
    // },
    {
        ...
        tools: ['ReactJS', '.NET Core', 'Redux', 'Rest API', 'Azure'],
        code: '',
        demo: '',
        image: ayla,
        role: 'Full Stack Developer',
